...
export async function writeMongo(condition, permitted, unpermitted, mongoCollection, ingredient, health, filler, taste, colour, description, username, conditionArray, consumed) {
...
export async function updateMongo(filterName, filterValue, updateName, updateValue, mongoCollection, updateName2, updateValue2, updateName3, updateValue3) {
    var data = JSON.stringify({
        "collection": mongoCollection,
        "database": mongoDatabase,
        "dataSource": mongoDataSource,
        ...
        "update": {
            "$set": {
                ...
                [updateName2]: updateValue2,
                [updateName3]: updateValue3
